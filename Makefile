...
foswiki-install-shared-hosting.pl : foswiki-install-shared-hosting-preamble.pl $(CPAN_LIBS) $(FOSWIKI_BASE_FILENAME).tgz.uuencode FastCGIEngineContrib.tgz.uuencode Item9699Contrib.tgz.uuencode
...
Item9699Contrib.tgz.uuencode : Item9699Contrib.tgz
	perl -Ilib/CPAN/lib/ puuencode Item9699Contrib.tgz >Item9699Contrib.tgz.uuencode
...
Item9699Contrib.tgz : 
	wget 'http://foswiki.org/pub/Extensions/Testing/Item9699Contrib/Item9699Contrib.tgz'

#

clean :
	-rm *~ $(RELEASE_FILES) foswiki-install-shared-hosting.pl $(FOSWIKI_BASE_FILENAME).tgz.uuencode FastCGIEngineContrib.tgz.uuencode Item9699Contrib.tgz.uuencode 2>/dev/null

realclean : clean
	-rm $(FOSWIKI_BASE_FILENAME).tgz FastCGIEngineContrib.tgz Item9699Contrib.tgz 2>/dev/null
